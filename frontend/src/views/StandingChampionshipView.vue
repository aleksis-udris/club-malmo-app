...
<template>
  <div class="space-y-5">
    <div>
      <h1 class="text-2xl font-extrabold text-slate-800">ESF Championship — Standings</h1>
      <p class="text-sm text-slate-400">Positions 1–8 and the latest championship matches</p>
    </div>
